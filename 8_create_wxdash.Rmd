...
```{r}
ts_data <- survey_data %>% 
  select(data.frame(groups)$groups, follow, plan_around, und_weather)

selectInput(inputId = 'ts_meas', label = 'Select a measure', choices = names(ts_data %>% select(follow:und_weather)))
