...
**Note.** Select the *Survey Hazard* grouping to see the difference across hazards.
...
**Note.** These data, like most survey data, come from non-probability samples that are not necessarily representative of the entire US population. Use cation when making inferences and drawing conclusions.
