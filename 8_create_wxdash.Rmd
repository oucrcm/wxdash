...
```{r}
prop_data_long <- select(survey_data, p_id, extprob_a_prob, extprob_b_prob, extprob_c_prob) %>% pivot_longer(extprob_a_prob:extprob_c_prob, names_to = "Prob_Time", values_to = "Prob")
int_data_long <- select(survey_data, p_id, extprob_a_int, extprob_b_int, extprob_c_int) %>% pivot_longer(extprob_a_int:extprob_c_int, names_to = "Int_Time", values_to = "Int")
perc_data_long <- select(survey_data, p_id, extprob_a, extprob_b, extprob_c) %>% pivot_longer(extprob_a:extprob_c, names_to = "Perc_Time", values_to = "Perc")
long_data <- left_join(prop_data_long, int_data_long, by = "p_id")
long_data <- left_join(long_data, perc_data_long, by = "p_id")
